...
import com.payment.warehouse.FileUploadUtil;
import com.payment.warehouse.brand.BrandService;
import com.payment.warehouse.category.CategoryService;
...
//        ProductSaveHelper.deleteExtraImagesWeredRemovedOnForm(product);
    ...
    public String editProduct(@PathVariable("id") Integer id, Model model,
                              RedirectAttributes ra, @AuthenticationPrincipal AppUserDetails loggedUser) {
        try {
